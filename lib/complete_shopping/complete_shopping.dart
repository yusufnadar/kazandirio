...
import 'package:kazandirio/complete_shopping/complete_shopping1.dart';
...
class CompleteShopping extends StatefulWidget {
  @override
  _CompleteShoppingState createState() => _CompleteShoppingState();
}
            ...
            onTap: () {
              Navigator.of(context)
                ...
                MaterialPageRoute(
                  ...
                  .then((value) async {
                await _userProvider.getAddress1(_userProvider.user);
              });
            },
            child: Row(
              children: [
            ...
            onTap: () {
              Navigator.of(context)
                ...
                MaterialPageRoute(
                  ...
                  .then((value) async {
                await _userProvider.getBillAddress1(_userProvider.user);
              });
            },
            child: Row(
              children: [
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    _userProvider.user.basket.toString() + ".00 TL",
                    style: TextStyle(
            ...
            GestureDetector(
              onTap: () {
                if (_currentIndex != null && _currentIndex1 != null) {
                  Navigator.of(context, rootNavigator: true).push(
                    MaterialPageRoute(
                      builder: (context) => CompleteShopping1(
                        totalPrice: _userProvider.user.basket,
